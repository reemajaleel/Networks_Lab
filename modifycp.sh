...
ksb@ksb-ThinkCentre-Edge72:~/Reema/Networks/Script$ cat f5.txt
abc
defg
defg
abc

ksb@ksb-ThinkCentre-Edge72:~/Reema/Networks/Script$ sh modifycp.sh f5.txt f6.txt
File successfully copied

ksb@ksb-ThinkCentre-Edge72:~/Reema/Networks/Script$ cat f6.txt
abc
defg
defg
abc
